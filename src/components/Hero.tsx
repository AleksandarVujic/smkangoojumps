  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <button onClick={handleWatchDemo} className="inline-flex items-center px-8 py-4 border-2 border-neutral-300 text-neutral-700 rounded-full font-semibold hover:border-accent-pink hover:text-accent-pink transition-all duration-300">
      ...
      <VideoModal
        ...
        videoUrl="assets/videos/video_demo.mp4"
        title="Kangoo Jumps Demo - Experience the Bounce!"
      />
    </>
  );
};
